  ...
  return (
    ...
    >
      <div className="w-[45%] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex items-center flex-col">
        ...
        <button
          className="w-[150px] h-[48px] focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900"
